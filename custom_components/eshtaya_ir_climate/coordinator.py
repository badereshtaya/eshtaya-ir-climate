...
class EshtayaIrClimateCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def async_bootstrap_ir_learning(self) -> None:
        """Import recent Smart Life ir_send commands without blocking setup on failure."""
        end_time = _now_ms()
        ...
        try:
            ...
            await self._learn(operation_logs, report_logs)
    ...
    async def async_sync_ir_library(
        ...
        *,
        ...
        """Manual full library sync used by the Home Assistant button."""
        end_time = _now_ms()
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        if (
            ...
            try:
                ...
                # Reuse recent report logs where possible; fetch a matching
                # window when the command window is wider.
