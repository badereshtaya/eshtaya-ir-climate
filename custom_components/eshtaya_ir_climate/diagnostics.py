...
async def async_get_config_entry_diagnostics(
    ...
    for device_id, coordinator in runtime.coordinators.items():
        devices[device_id] = {
            ...
            "last_ir_key": coordinator.last_ir_key,
            "last_ir_result": coordinator.last_ir_result,
            "last_ir_error": coordinator.last_ir_error,
            "ir_library": coordinator.ir_library.diagnostics(),
